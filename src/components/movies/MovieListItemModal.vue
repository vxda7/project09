    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <!-- 영화 제목을 출력하세요. -->
          <h5 class="modal-title">{{movieDataFromItem.name}}</h5>
        ...
        <div class="modal-body">
          <!-- 영화 설명을 출력하세요. -->
          <img class="movie--poster my-3" v-bind:src="movieDataFromItem.poster_url" alt="">
          <hr>
          <p>{{movieDataFromItem.description}}</p>
        </div>
